		...
		<div class="container">
			<div class="col-xs-12">
				<div class="resume-intro">
					...
					%>
					<form id="modifycv-form" action="modify_cv_700.action?pageNo=1"
						method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label for="name">姓名:</label> <input type="text"
								class="form-control" value="<%=cv.getName()%>" name="name">
						</div>
						<div class="form-group">
							<label for="name">身份证号:</label> <input type="text"
								class="form-control" value="<%=cv.getIdnumber()%>"
								name="idnumber">
						</div>
						<div class="form-group">
							<label for="name">手机号码:</label> <input type="text"
								class="form-control" value="<%=cv.getPnumber()%>" name="pnumber">
						</div>
						<div class="form-group">
							<label for="name">性别:</label> <input type="text"
								class="form-control" value="<%=cv.getSex()%>" name="sex">
						</div>
						<div class="form-group">
							<label for="name">生日:</label> <input type="text"
								class="form-control" value="<%=cv.getBirthday()%>"
								name="birthday">
						</div>
						<div class="form-group">
							<label for="name">年龄:</label> <input type="text"
								class="form-control" value="<%=cv.getAge()%>" name="age">
						</div>
						<div class="form-group">
							<label for="name">概要:</label> <input type="text"
								class="form-control" value="<%=cv.getSummary()%>" name="summary">
						</div>
						<div class="form-group">
							<label for="name">经历:</label> <input type="text"
								class="form-control" value="<%=cv.getExperience()%>"
								name="experience">
						</div>
						<div class="form-group">
							<label for="name">奖项:</label> <input type="text"
								class="form-control" value="<%=cv.getPrize()%>" name="prize">
						</div>
						<div class="form-group">
							<label for="name">学校:</label> <input type="text"
								class="form-control" value="<%=cv.getSchool()%>" name="school">
						</div>
						<%-- <img src="<%=cv.getPrictureurl()%>"> --%>
						<div class="form-group">
							<label for="inputfile">请选择需要上传的头像：</label> <input type="file"
								name="upload" />
						</div>
