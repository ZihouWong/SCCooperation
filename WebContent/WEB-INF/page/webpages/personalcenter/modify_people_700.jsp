		...
		<div class="container">
			<div class="col-xs-12">
				<div class="resume-intro">
					...
					%>
					<form id="modifycv-form" action="modify_people_700.action?pageNo=1"
						method="post" enctype="multipart/form-data">

						<div class="form-group">
							<label for="name">姓名:</label> <input type="text"
								class="form-control" value="<%=people.getName()%>" name="name">
						</div>
						<div class="form-group">
							<label for="name">身份证号:</label> <input type="text"
								class="form-control" value="<%=people.getIdnumber()%>"
								name="idnumber">
						</div>
						<div class="form-group">
							<label for="name">手机号码:</label> <input type="text"
								class="form-control" value="<%=people.getPnumber()%>"
								name="pnumber">
						</div>
						<div class="form-group">
							<label for="name">性别:</label> <input type="text"
								class="form-control" value="<%=people.getSex()%>" name="sex">
						</div>
						<div class="form-group">
							<label for="name">生日:</label> <input type="text"
								class="form-control" value="<%=people.getBirthday()%>"
								name="birthday">
						</div>
						<div class="form-group">
							<label for="name">年龄:</label> <input type="text"
								class="form-control" value="<%=people.getAge()%>" name="age">
						</div>
						<div class="form-group">
							<label for="name">概要:</label> <input type="text"
								class="form-control" value="<%=people.getSummary()%>"
								name="summary">
						</div>
						...
						<div class="form-group">
							<label for="name">昵称:</label> <input type="text"
								class="form-control" value="<%=people.getUsername()%>"
								name="username">
						</div>
						<div class="form-group">
							<label for="name">邮箱:</label> <input type="text"
								class="form-control" value="<%=people.getMail()%>" name="mail">
						</div>
						<div class="form-group">
							<label for="name">QQ:</label> <input type="text"
								class="form-control" value="<%=people.getQq()%>" name="qq">
						</div>
