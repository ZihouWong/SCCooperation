			...
			<div class="col-xs-12">
			    ...
			    <div class="navbar-right">
			    	<ul class="navbar-body">
			    		...
			    		<li class="navbar-body-item"><a href="gongxing.action" class="navbar-link">躬行课堂</a></li>
			    		<li class="navbar-body-item"><a href="chuangxinggu.action" class="navbar-link">创行谷管理</a></li>
			    		<li class="navbar-body-item"><a href="luntan.action?pageNo=1" class="navbar-link">知行圈</a></li>
			    		<li class="navbar-body-item"><a href="geren.action" class="navbar-link">个人中心</a></li>
			    	</ul>
			    </div>
			</div>
		</div>
    			...
    			<div class="col-xs-3">
				    ...
				    <div class="menu">
						<ul class="menu-list">
							...
							<li class="menu-title">
								<a href="JobClassification.action?buttom=biancheng"><span>编程</span></a>
								<a href="https://www.sina.com/?buttom=sheji"><span>设计</span></a>
								<a href="https://www.runoob.com/?buttom=ITruanjian"><span>IT软件</span></a>
							</li>
							
							<li class="menu-title">
								<a href="https://www.baidu.com/?buttom=qiuzhi"><span>求职</span></a>
								<a href="https://www.sina.com/?buttom=zhichang"><span>职场</span></a>
								<a href="https://www.runoob.com/?buttom=bangongruanjian"><span>办公软件</span></a>
							</li>
							
							<li class="menu-title">
								<a href="https://www.baidu.com/?buttom=english"><span>英语</span></a>
								<a href="https://www.sina.com/?buttom=japanese"><span>日语</span></a>
								<a href="https://www.runoob.com/?buttom=french"><span>法语</span></a>
								<a href="https://www.runoob.com/?buttom=Korean"><span>韩语</span></a>
							</li>
							
							<li class="menu-title">
								<a href="https://www.baidu.com/?buttom=yingxiao"><span>营销</span></a>
								<a href="https://www.sina.com/?buttom=licai"><span>理财</span></a>
								<a href="https://www.runoob.com/?buttom=zhuanyezhishi"><span>专业技能</span></a> 
							</li>
							
							<li class="menu-title">
								<a href="https://www.baidu.com/?buttom=kuaijizheng"><span>会计证</span></a>
								<a href="https://www.sina.com/?buttom=gangqin"><span>钢琴</span></a>
								<a href="https://www.runoob.com/?buttom=jianzhushi"><span>建造师</span></a>
							</li>
							
							<li class="menu-title">
								<a href="https://www.baidu.com/?buttom=guoxue"><span>国学</span></a>
								<a href="https://www.sina.com/?buttom=shengxue"><span>省学</span></a>
								<a href="https://www.runoob.com/?buttom=xuelijiaoxue"><span>学历教育</span></a>
							</li>
							
							<li class="menu-title">
								<a href="https://www.baidu.com/?buttom=gaokao"><span>高考</span></a>
								<a href="https://www.sina.com/?buttom=zhongkao"><span>中考</span></a>
								<a href="https://www.runoob.com/?buttom=xiaoshengchu"><span>小升初</span></a>
							</li>
							
							<li class="menu-title">
								<a href="https://www.baidu.com/?buttom=>kaoyan"><span>考研</span></a>
								<a href="https://www.sina.com/?buttom=siliuji"><span>四六级</span></a>
								<a href="https://www.runoob.com/?buttom=jisuanjikaoshi"><span>计算机考试</span></a>
							</li>
							
							<li class="menu-title">
								<a href="https://www.baidu.com/?buttom=yashi"><span>雅思</span></a>
								<a href="https://www.sina.com/?buttom=tuofu"><span>托福</span></a>
								<a href="https://www.runoob.com/?buttom=liuxuezhidao"><span>留学指导</span></a>
							</li>
							
							<li class="menu-title">
								<a href="https://www.baidu.com/?buttom=shenghuo"><span>生活</span></a>
								<a href="https://www.sina.com/?buttom=wenhua"><span>文化</span></a>
								<a href="https://www.runoob.com/?buttom=xingqu"><span>兴趣</span></a>
							</li>
							<li class="menu-title">
								<a href="https://www.baidu.com/?buttom=xueshu"><span>学术</span></a>
								<a href="https://www.sina.com/?buttom=TED"><span>TED</span></a>
								<a href="https://www.runoob.com/?buttom=mingxiaogongkaike"><span>名校公开课</span></a>

							</li>
						</ul>
						<div class="menu-body display">
							<div class="menu-body-item display">
								<dl>
									<dt>
										<a href="#" class="menu-body-item-title">编程语言<i>&gt;</i></a>
									</dt>
									<dd>
										<a href="#">C/C++</a>
										<a href="#">VC/MFC</a>
    			...
    			<div class="col-xs-9">
    				<div class="carousel">
						<div id="owl-demo" class="owl-carousel">
							<a class="item"><img src="./img/owl-img1.jpg" alt=""></a>
    			   ...
    			   <div class="hot-company-body">
    			   	  <div class="col-xs-3">
    			   	  	 <div class="hot-company-body-item">
    			   	  	 	<img class="company-logo" src="./img/hot-company1.png" alt="">
    			   	  	 	<p class="hot-company-name"><a href="#">还呗</a></p>
    			   	  	 	<p class="company-intro grey2">移动互联网,金融 不需要融资</p>
    			   	  	 	<p class="company-intro">移动金融，未来金矿；精英团队</p>
    			   	  	 	<span class="hot-work-body-border"></span>
                           <!--  <ul class="hot-company-list"> -->
                            	<a href="#" class="hot-company-list-item float">
                            		<span class="main-color">122</span>
                            		<p class="main-font float  hot-company-list-intro">面试评价</p>
                            		<span class="hot-company-list-border"></span>
                            	</a>
                            	<a href="#" class="hot-company-list-item float">
                            		<span class="main-color">38</span>
                            		<p class="main-font float  hot-company-list-intro">在找职位</p>
                            		<span class="hot-company-list-border"></span>
                            	</a>
    			   	  ...
    			   	  <!-- col-xs-3 ending --><div class="col-xs-3">
    			   	  	 <div class="hot-company-body-item">
    			   	  	 	<img class="company-logo" src="./img/hot-company1.png" alt="">
    			   	  	 	<p class="hot-company-name"><a href="#">还呗</a></p>
    			   	  	 	<p class="company-intro grey2">移动互联网,金融 不需要融资</p>
...
-------------------------------------------------------------------------------!*/
	        ...
	        $(".menu")
	           .on('mouseenter',function(e){
			       ...
			       $(".menu-title").on('mouseenter',function(e){
			       	    $(this).addClass('active');
			           	var index = $(".menu-title").index(this);
			            $(".menu-body-item").eq(index).show().siblings().hide();
		           });
...
/*!Tab
-------------------------------------------------------------------------------!*/
	       $(".hot-work-head-item").click(function(){
           	  $(this).addClass("selected").siblings().removeClass("selected");
           	  var index = $(".hot-work-head-item").index(this);
              $(".hot-work-body").eq(index).show().siblings().hide();
           });
/*!侧边菜单栏
-------------------------------------------------------------------------------!*/
