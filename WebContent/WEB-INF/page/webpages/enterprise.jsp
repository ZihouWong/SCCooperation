				  ...
				  <div class="resume-intro-right">
				  	<div class="resume-detail">
							...
							<!-- 	<a href="#" class="user-img"><i  class="fa fa-user-o fa-5x fa-normal"></i>
									...
									<%
									List tagno = (List)request.getSession().getAttribute("tag");
							...
							<div class="resume-menu">
								...
								<div class="col-xs-2">
									<a href="#" class="resume-menu-item">
										...
										<p class="font-intro font-intro-right">发布视频</p>
									</a>
								</div>
								<!-- resume-menu-item ending -->
								<div class="col-xs-2">
								...
								<div class="col-xs-2">
									<a href="#" class="resume-menu-item">
										...
										<p class="font-intro font-intro-right">更多操作</p>
									</a>
								</div>
								<!-- resume-menu-item ending -->
							</div>
