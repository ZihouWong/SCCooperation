		...
		<div class="container">
			<div class="col-xs-12">
				<div class="resume-intro">
					...
					<form id="newannouncement" action="addnotification.action"
						method="post" enctype="multipart/form-data">
						<p class="main-font">新建公告</p>

						<div class="form-group">
							<label for="name">公告标题:</label> <input type="text"
								class="form-control" name="title">
						</div>
						<div class="form-group">
							<label for="name">公告内容</label>
							<textarea class="form-control" name="contect" rows="6"></textarea>
						</div>
