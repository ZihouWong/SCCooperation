...
<body>
	...
	<div id="head-link" class="login">
		<div class="container">
			...
			System.out.println("开始获取enterprisesubuser");
			Enterprisesubuser enterprisesubuser =(Enterprisesubuser) listEsu.get(0);
			System.out.println("获取完成enterprisesubuser");
			System.out.println(enterprisesubuser.getNickname());
			%>
				<div class="login-in">
					<p class="main-font">欢迎<%=enterprisesubuser.getNickname()%>></p>
				</div>
			    <div class="login-tel">
			    	<i class="fa fa-phone fa-lg"></i>
			    	<p class="main-font">咨询电话：<%=enterprisesubuser.getTel() %></p>
			    </div>
			</div>
		</div>
	</div>
			...
			<div class="col-xs-12">
				<div class="resume-intro">
				  <div class="resume-intro-left">
				  	 <p class="font-title float"><%=enterprisesubuser.getNickname() %></p>
					 <p class="main-font float"><%=enterprisesubuser.getEname() %></p>
					 <p class="main-font float"><%=enterprisesubuser.getTel() %></p>
					 ...
					 <div class="resume-info">
					 	<form action="" method="post" class="people-info">
						 	...
						 	<p class="main-font">联系电话：<%=enterprisesubuser.getTel() %></p>
						 	<p class="main-font">QQ：<%=enterprisesubuser.getQq() %></p>
					 	</form>
				  ...
				  <div class="resume-intro-right">
				  	<div class="resume-detail">
							...
							<!-- 	<a href="#" class="user-img"><i  class="fa fa-user-o fa-5x fa-normal"></i>
									...
									<a href="#" class="user-img"><img src="<%=enterprisesubuser.getPictureurl()%>"></a>
									<%
									...
									%>
									<p class="main-font text-center">所属企业类型：<%=tag1.getTagname() %>／<%=tag2.getTagname() %>／<%=tag3.getTagname() %></p>
							...
							<div class="resume-menu">
								...
								<div class="col-xs-2">
									<a href="esu_display_password.action" class="resume-menu-item">
								...
								<!-- resume-menu-item ending -->
								<div class="col-xs-2">
									<a href="esu_display_enterprisesubuserinfo.action" class="resume-menu-item">
										<i class="fa fa-pencil-square-o fa-2x"></i>
										<p class="font-intro">修改企业子用户信息</p>
									</a>
								</div>
								<!-- resume-menu-item ending -->
								<div class="col-xs-2">
								...
								<!-- resume-menu-item ending -->
								<div class="col-xs-2">
									<a href="esudisproject.action?pageNo=1" class="resume-menu-item">
