...
<body>
	...
	<div id="head-link" class="login">
		<div class="container">
			...
			%>
				<div class="login-in">
					<p class="main-font">欢迎<%=people.getName()%>></p>
				</div>
			    <div class="login-tel">
				  ...
				  <div class="resume-intro-left">
					 ...
					 <div class="resume-info">
					 	<form action="" method="post" class="people-info">
						 	...
						 	<p class="main-font">手机：<%=people.getPnumber() %></p>
						 	<p class="main-font">邮箱：<%=people.getMail() %></p>
					 	</form>
				  ...
				  <div class="resume-intro-right">
				  	<div class="resume-detail">
							...
							<!-- 	<a href="#" class="user-img"><i  class="fa fa-user-o fa-5x fa-normal"></i>
									...
									<a href="#" class="user-img"><img src="<%=people.getPicture()%>"></a>
									<%
									...
									%>
									<p class="main-font text-center">求职方向：<%=tag1.getTagname() %>／<%=tag2.getTagname() %>／<%=tag3.getTagname() %></p>
							...
							<div class="resume-menu">
								...
								<div class="col-xs-2">
									<a href="display_cv_700.action" class="resume-menu-item">
								...
								<!-- resume-menu-item ending -->
								<div class="col-xs-2">
									<a href="displaynotification.action?pageNo=1" class="resume-menu-item">
				...
				<div class="apply-work">
				    ...
				    <form action="" method="post" name="apply-form">
				    	...
				    	<div class="apply-work-item">
                            ...
                            <p class="main-font red salary"><%=((Post)post.get(0)).getRemuneration() %>元/月</p>
                            ...
                            <p class="font-intro grey2 work-time float">开始时间：<%=((Post)post.get(0)).getPtime() %> 报名截止时间：<%=((Post)post.get(0)).getStime() %></p>
				    	...
				    	<div class="apply-work-item">
                            ...
                            <p class="main-font red salary"><%=((Post)post.get(1)).getRemuneration() %>元/月</p>
                            <i class="fa fa-chevron-circle-down fa-3x grey2 float-right"></i>
                            <p class="font-intro grey2 work-group float">佛山海联中兴企业管理中心</p>
                            <p class="font-intro grey2 work-place float"><%=((Post)post.get(1)).getPlace() %></p>
                            <p class="font-intro grey2 work-time float">开始时间：<%=((Post)post.get(1)).getPtime() %> 报名截止时间：<%=((Post)post.get(1)).getStime() %></p>
				    	...
				    	<div class="apply-work-item">
                            ...
                            <p class="main-font red salary"><%=((Post)post.get(2)).getRemuneration() %>元/月</p>
                            <i class="fa fa-chevron-circle-down fa-3x grey2 float-right"></i>
                            <p class="font-intro grey2 work-group float">佛山海联中兴企业管理中心</p>
                            <p class="font-intro grey2 work-place float"><%=((Post)post.get(2)).getPlace() %></p>
                            <p class="font-intro grey2 work-time float">开始时间：<%=((Post)post.get(2)).getPtime() %> 报名截止时间：<%=((Post)post.get(2)).getStime() %></p>
