	...
	<div id="head-link" class="login">
		<div class="container">
			...
			%>
				<div class="login-in">
					<p class="main-font">
						欢迎<%=enterprise.getEname()%>>
					</p>
				</div>
				<div class="login-tel">
					<i class="fa fa-phone fa-lg"></i>
					<p class="main-font">
						咨询电话：<%=enterprise.getContact() %></p>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="resume-intro-left">
						...
						<div class="resume-info">
							<form action="" method="post" class="people-info">
								...
								<p class="main-font">
									联系电话：<%=enterprise.getContact() %></p>
								<p class="main-font">
									官网：<%=enterprise.getWebsite() %></p>
							</form>
					...
					<div class="resume-intro-right">
						<div class="resume-detail">
							...
							<a href="#" class="user-img"><img
								src="<%=enterprise.getPictureurl()%>"></a>
							<%
							...
							<p class="main-font text-center">
								企业类型：<%=tag1.getTagname() %>／<%=tag2.getTagname() %>／<%=tag3.getTagname() %></p>
						...
						<div class="resume-menu">
							...
							<div class="col-xs-2">
								<a href="e_display_enterpriseinfo.action"
									class="resume-menu-item"> <i class="fa fa-eye fa-2x"></i>
