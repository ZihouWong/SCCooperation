...
<div class="nav">
 <div id="wrap-nav">
	<ul class="menu ul">
		...
		<li>
			<h3 id="menu_01" style="background-color:#82CCC9/*6ed3cf*/; opacity:1;filter(alpha=150);  width: 205px; padding-left: 15px;"><a href="#" class="depth_1">设计素材</a></h3>
			<ul id="children_01" class="children">
				<li>
					<h3 id="menu_01a"><a href="#" class="depth_2"><span class="icon10"></span>高清图片</a></h3>
					<ul id="children_01a">
				...
				<li>
					<h3 id="menu_01b"><a href="#" class="depth_2"><span class="icon10"></span>矢量</a></h3>
					<ul id="children_01b">
				...
				<li>
					<h3 id="menu_01i"><a href="#" class="depth_2"><span class="icon10"></span>Flash文件</a></h3>
					<ul id="children_01i">
		...
		<li><h3><a href="#" class="depth_1">原创作品</a></h3></li>
		<li><h3><a href="#" class="depth_1">经验分享</a></h3></li>
		<li><h3><a href="#" class="depth_1">设计趋势</a></h3></li>
		<li><h3><a href="#" class="depth_1">设计趋势</a></h3></li>		
	</ul>
	 <ul class="mn_extd">
	 <li >
          <a class="a2" target="_blank" style="" href="//chuanke.baidu.com/?mod=school&act=create">创建学校</a>
          </li>
     </ul>
 </div>
</div>
