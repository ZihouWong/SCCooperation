...
//		int sum=0;
		...
		for(int moth=1;moth<7;moth++)
		{
			...
			{
				int tennext=ten+10;
				FileInputStream in = new FileInputStream("D:\\spss\\2016z\\2016."+moth+"."+ten+"-2016."+moth+"."+tennext+".txt"); 
				InputStreamReader inReader = new InputStreamReader(in, "UTF-8");  
			    BufferedReader bufReader = new BufferedReader(inReader);  
			    String line = null;  
			    String neizi = "============================================================以下为内资\n";
			    ...
			    while((line = bufReader.readLine()) != null){  
			    	...
			    	Pattern p = Pattern.compile("^\\d{6}[0-1].*");
			    	Matcher m = p.matcher(line);
			        if(m.find())
			        {
			        	neizi +=line+"\r\n";
			        ...
			        Pattern p4 = Pattern.compile("^\\d{6}[2].*");
			    ...
			    int ss=sum[0]+sum[1]+sum[2]+sum[3]+sum[4];
			    System.out.println("其中内资为"+sum[0]+"外资为"+sum[2]+"  私营为"+sum[4]+"农民为"+sum[1]+"个体为"+sum[3]+"总计为"+ss);
			    bufReader.close();  
			    inReader.close();  
			    in.close();  
			
			    File dir = new File("D:\\spss\\2016zs\\2016."+moth+"."+ten+"-2016."+moth+"."+tennext+".txt");  
			    OutputStreamWriter oStreamWriter = new OutputStreamWriter(new FileOutputStream(dir), "utf-8");
			    oStreamWriter.write(waizi+neizi+nongmin+geti+"\r\n"+" 其中内资为"+sum[0]+"  外资为"+sum[2]+"  私营为"+sum[4]+"  农民为"+sum[1]+"  个体为"+sum[3]+"  总计为"+ss);
			    oStreamWriter.close(); 
			    zongjie+=moth+"."+ten+"-2016."+moth+"."+tennext+"  其中内资为"+sum[0]+"  外资为"+sum[2]+"  私营为"+sum[4]+"  农民为"+  sum[1]+"  个体为"+sum[3]+"  总计为"+ss+"\r\n";
			}
...
//			else
//			{
//				FileInputStream in = new FileInputStream("D:\\spss\\2017z\\2017."+moth+".txt"); 
//				InputStreamReader inReader = new InputStreamReader(in, "UTF-8");  
//			    BufferedReader bufReader = new BufferedReader(inReader);  
//			    String line = null;  
//			    String neizi = "============================================================以下为内资\n";
...
//			    String h = neizi+waizi+nongmin+geti;
//			
//			    File dir = new File("D:\\spss\\2017zs\\2017."+moth+".txt");  
//			    OutputStreamWriter oStreamWriter = new OutputStreamWriter(new FileOutputStream(dir), "utf-8");
//			    oStreamWriter.write(waizi+neizi+nongmin+geti+"\r\n"+"  其中内资为"+sum[0]+"  外资为"+sum[2]+"  私营为"+sum[4]+"  农民为"+sum[1]+"  个体为"+sum[3]+"总计为"+ss);
//			    oStreamWriter.close(); 
//			    zongjie+="2017."+moth+"  其中内资为"+sum[0]+"  外资为"+sum[2]+"  私营为"+sum[4]+"  农民为"+sum[1]+"  个体为"+sum[3]+"  总计为"+ss+"\r\n";
//			}
			

		}
		File dir = new File("D:\\spss\\2016zs\\2016.zongjie.txt");  
	    OutputStreamWriter oStreamWriter = new OutputStreamWriter(new FileOutputStream(dir), "utf-8");
